/*
    ...
    GLSC2, OpenGL, OpenGL ES loader generated by glad 0.1.29 on Wed May  8 15:34:46 2019.

    Language/Generator: C/C++
    Specification: gl
    APIs: gl=4.1, gles2=3.2, glsc2=2.0, gles1=1.0
    ...
    Commandline:
        --profile="compatibility" --api="gl=4.1,gles2=3.2,glsc2=2.0,gles1=1.0" --generator="c" --spec="gl" --extensions=""
    Online:
        https://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&loader=on&api=gl%3D4.1&api=gles2%3D3.2&api=glsc2%3D2.0&api=gles1%3D1.0
*/
